...
#ifdef marc
LiquidCrystal lcd(44, 48, 43, 45, 47, 49); //wiring Marc<
#endif
#ifndef marc
LiquidCrystal lcd(22, 23, 25, 27, 29, 31); //wiring Jan
#endif
uint8_t x_pos = 0;
uint8_t y_pos = 0;
int8_t z_pos = 0;
...
void fn_run(m2_el_fnarg_p fnarg) {
  ...
  error = XX.sendgcode ("G38.2 Z-40 F20000");  // probe
  error =XX.sendgcode("G91"); // relative postion mode
  error = XX.sendgcode("G1Z20"); // probe 20 mm up
