...
char * P;
P = buf;
*gcode_buffer_first_set[3] = 'K';
*gcode_buffer_first_set[0] = 'd', 'a';
*gcode_buffer_first_set[1,8] = *buf+7;  // compileert maar rubisch
*gcode_buffer_first_set[2] = *buf;
//gcode_buffer_first_set[4] = "Jan Pietersen                ";
gcode_buffer_first_set[4][0] = buf[1];
    gcode_buffer_first_set[4][1] = buf[2];
    gcode_buffer_first_set[4][2] = buf[3];
}
}
